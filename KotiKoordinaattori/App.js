...
function KotiDrawer() {
  ...
  const screenOptions = {
    ...
    headerRight: () => (
      <TouchableOpacity onPress={toggleDrawer}>
        <MenuUnfoldOutlined
          style={{ fontSize: "24px", color: "#000", marginRight: 10 }}
        />
      </TouchableOpacity>
    ),
  };
  ...
  return (
    <Drawer.Navigator initialRouteName="KotiKoordinaattori">
      ...
      />
      <Stack.Screen
        name="VahinkoIlmoitusTaulu"
        component={VahinkoIlmoitusScreen}
        options={{
          headerStyle: {
            backgroundColor: "cornflowerblue",
          },
